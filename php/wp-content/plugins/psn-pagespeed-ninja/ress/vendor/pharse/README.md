...
The Pharse is a fork of [Ganon](http://code.google.com/p/ganon) library and gives access to HTML/XML documents in a very simple object-oriented way. It eases modifying the DOM and makes finding elements easy with CSS3-like queries.
