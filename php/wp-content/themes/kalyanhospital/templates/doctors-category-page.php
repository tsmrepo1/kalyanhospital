<?php
/**Template Name: Doctors Category Page
 */
get_header();
while ( have_posts() ) : the_post(); 
$current_url = home_url($_SERVER['REQUEST_URI']); 
$str = $current_url;
$cat_name = explode("=",$str)[1];
?>
<div class="main__body__wrapp main__body__wrapp__inner">
   ...
   <div class="inner__doctor">
      <div class="container">
         ...
         <?php
         if($cat_name == 'ASC'){
            $argsDoctors = array( 'post_type' => 'doctors_management', 'posts_per_page'=>-1, 'orderby'=>'title','order'=>'ASC');

         }elseif ($cat_name == 'DSC') {
            $argsDoctors = array( 'post_type' => 'doctors_management', 'posts_per_page'=>-1, 'orderby'=>'title','order'=>'DSC');
         }else{
               $argsDoctors = array(
               'post_type' => 'doctors_management', 'posts_per_page' => -1, 'orderby' => 'menu_order', 'order' => 'ASC',
               'tax_query' => array(
               array(
                'taxonomy' => 'doctors_category',
                'field' => 'slug',
         ...
         <?php }
             ...
             ?>
             <div class="no-data-found"><p><?php  echo __( 'No Data Found' );?> </p></div>  <?php
           } wp_reset_postdata(); 
          ?>
